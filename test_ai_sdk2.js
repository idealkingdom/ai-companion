...
var ai_1 = require("ai");
var openai = (0, openai_1.createOpenAI)({ apiKey: 'sk-fake' });
var list_workspace = (0, ai_1.tool)({
...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var result, _a, _b, _c, chunk, e_1_1, e_2;
        var _d, e_1, _e, _f;
            ...
            switch (_g.label) {
                case 0:
                    ...
                    result = (0, ai_1.streamText)({
                        ...
                        tools: { list_workspace: list_workspace },
                        maxSteps: 1
                    });
                    _g.label = 1;
                case 1:
                ...
                case 13:
                    e_2 = _g.sent();
                    console.error("CAUGHT:", e_2.message);
                    return [3 /*break*/, 14];
